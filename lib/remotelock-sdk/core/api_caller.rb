...
module RemoteLock
  ...
  class ApiCaller
    ...
    # This is used by the RemoteLock::Unstable::Spy methods to stream data.
    ...
    def get_stream(path, query = {}, opts = {})
      ...
      raise RemoteLock::Exception::NetworkTimeout
    ...
    def setup_endpoint(creds)
      ...
      @net = { headers: headers(creds), scheme: opts[:scheme] || 'https', 
               endpoint: creds[:endpoint], api_base: calling_class.api_path }
    end
