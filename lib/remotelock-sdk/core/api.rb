...
module RemoteLock
  ...
  # any call to the RemoteLock API from this SDK, you are returned an
  # OpenStruct object.
  #
  # @return a RemoteLock::Response object
  #
  class CoreApi
    ...
    #   RemoteLock API server) and `token`, the user token with which
    ...
    #   RemoteLock. Passed through to the ApiCaller class.
    # @return [Nil]
    #
    ...
    def setup_api(creds, opts)
      RemoteLock::ApiCaller.new(self, creds, opts)
    end
