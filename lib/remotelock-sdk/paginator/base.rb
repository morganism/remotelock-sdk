...
module RemoteLock
  module Paginator
    ...
    #
    # * Calling with limit = :all iteratively calls the RemoteLock API,
    # returning all requested objects in a standard RemoteLock::Response
    # wrapper.
    #
    ...
    class Base
      ...
      # @param api_caller [RemoteLock::ApiCaller] the class which
      ...
      # @raise [RemoteLock::Exception::EnumerableError] if an API error
      #   is encountered at any point. The exception message is a
      #   RemoteLock::Type::Status object, which will include the HTTP
