...
module RemoteLock
  module Writer
    ...
    class Core
      ...
      rescue RemoteLock::Exception::InvalidMetricName,
             RemoteLock::Exception::InvalidMetricValue,
             RemoteLock::Exception::InvalidTimestamp,
             RemoteLock::Exception::InvalidSourceId,
             RemoteLock::Exception::InvalidTag => e
